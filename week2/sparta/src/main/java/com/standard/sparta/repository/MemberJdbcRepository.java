...
public class MemberJdbcRepository implements MemberRepository {
    ...
    public Member save(Member newMember) {
        ...
        int affectedRow = jdbcTemplate.update(connection -> {
            ...
            ps.setBoolean(3, newMember.getIsDeleted());
            return ps;
        }, keyHolder);
    ...
    public Member findById(Long memberId) {
        ...
        // queryForObject() 메서드 중에서 @Deprecated는 곧 서비스가 만료될 예정이라는 의미이므로
        // 잘 검색해 보고 @Deprecated Annotation이 붙은 메서드는 사용하지 말자.
    ...
    /**
     * 회원 정보 수정.
     * @param data 회정 정보 수정을 위한 Member 객체
     * @return Member
     */
    @Override
